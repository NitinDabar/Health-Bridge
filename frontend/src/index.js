...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route path="/" element={<App />}>
      ...
      <Route path="/emergency-care" element={<EmergencyCareScreen />} />
      <Route path="/opening-hours" element={<OpeningHoursScreen />} />
      ...
      <Route path="" element={<PrivateRoute />}>
        ...
        <Route path="/my-records" element={<MedicalRecordsScreen />} />
      </Route>
      {/* All Admin Routes */}
